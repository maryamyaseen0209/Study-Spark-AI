...
const meetingSchema = new mongoose.Schema({
  ...
  provider: { type: String, enum: ['zoom', 'manual'], default: 'zoom' },
  status: { type: String, enum: ['scheduled', 'cancelled', 'completed'], default: 'scheduled', index: true },
  joinUrl: String,
  startUrl: String,
  providerMeetingId: String,
  providerStatus: { type: String, enum: ['configured', 'configuration_required', 'manual'], default: 'configuration_required' },
  reminderSentAt: Date,
